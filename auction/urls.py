...
from .views import AuctionStatusViewSet, ContributorViewSet, AuctionViewSet, HighestBidViewSet
...
urlpatterns = [
    ...
    path('auction/<int:pk>/highest-bid', HighestBidViewSet.as_view(), name="highest_bid"),
